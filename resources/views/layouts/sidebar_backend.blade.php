      ...
      @if($permissionsArr['add-lead'] || $permissionsArr['edit-lead'] || $permissionsArr['list-lead'])
        <li><a><i class="fa fa-check-square-o"></i>{{lang_trans('sidemenu_leads')}} <span class="fa fa-chevron-down"></span></a>
          <ul class="nav child_menu">
            @if($permissionsArr['add-lead']) <li><a href="javascript:void(0);">{{lang_trans('sidemenu_lead_add')}} </a></li> @endif
            @if($permissionsArr['list-lead']) <li><a href="javascript:void(0);">{{lang_trans('sidemenu_lead_list')}} </a></li> @endif
          </ul>
        </li>
      @endif
