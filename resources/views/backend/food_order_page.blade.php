  ...
  <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
              ...
              <div class="menuSelect" style="display: none;">
              <div class="x_content">                
              ...
              <div class="col-md-12 col-sm-12 col-xs-12 text-left menuSelectMsg" >
                <p>* Choose the Menu package to view food items</p>
                </div>
...
<script>
    $(document).ready(function () {
        ...
        // Check if menu_id exists in URL
        let menuId = getUrlParameter('menu_id');

        if (menuId) {
            $('.menuSelect').show();   // Show menu selection div
            $('.menuSelectMsg').hide(); // Hide the message
            $("#menu_" + menuId).prop("checked", true); // Auto-select the radio button
        } else {
            $('.menuSelect').hide();   // Hide menu selection div
            $('.menuSelectMsg').show(); // Show the message
        }

        // Show menuSelect div and hide message when a menu is selected
        $('.menu-radio').change(function () {
            $('.menuSelect').show();
            $('.menuSelectMsg').hide();
        });
    });
