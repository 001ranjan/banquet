...
@section('content')
  @php 
    ...
    $room_num_string = implode(', ', $uri_params['room_num']);
  @endphp
<div>
...
<table class="table table-bordered">
    <tr>
      ...
      <tr>
        <th>Vanue</th>
        <td colspan="3"> {{ $room_num_string }}</td>
      </tr>
</table>

    {{ Form::open(array('url' => route('room-reservation-payment'),'class'=>"form-horizontal form-label-left",'files'=>true)) }}
    ...
    {{ Form::hidden('room_num', $room_num_string ?? '') }}
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 text-right">
      <button class="btn btn-success btn-submit-form" type="submit" disabled_>{{lang_trans('btn_next')}}</button>
    </div>
    {{ Form::close() }}
</div>
