            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <div class="row">
                        ...
                        {{ Form::hidden('duration_of_stay', null, ['id' => 'duration_of_stay']) }}
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <label class="control-label"> {{ lang_trans('txt_time_slot') }} <span class="required">*</span></label>
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-4 col-sm-4 col-xs-12">
                        ...
                        {{ Form::select('payment_mode', [
                              ...
                              'cash' => 'Cash',
                              'upi' => 'UPI'
                          ], null, ['class' => "form-control col-md-6 col-xs-12", "id" => "payment_mode"]) }}
                    </div>
                  </div>
                   <div class="ln_solid"></div>
                  <div class="col-md-12 col-sm-12 col-xs-12 text-right">
